...
return array(
    ...
    'admin_list_limits'=>'List Pagination',
    'admin_list_limits_tips'=>'Available page sizes for admin list tables, comma separated. E.g.: 15,10,20,25,50,100. The first value is the default page size.',
    ...
    'config_inc_not_write'=>'File jisucms/config/config.inc.php no write permission',
    ...
    'max_size'=>'Max Size',
    'upload_filename_style'=>'Filename Style',
    'upload_filename_style_tips'=>'Naming style for uploaded files saved on server. Default: UUID (recommended)',
    'upload_style_uuid'=>'UUID (with hyphens, 36 chars)',
    'upload_style_uuid_compact'=>'UUID compact (no hyphens, 32 chars)',
    'upload_style_legacy'=>'Legacy (timestamp + random)',
    ...
    'batch_add_cate'=>'Batch Add Category',
    ...
    'alias_tips'=>'unicode letter (e.g. Chinese) / number / - / _',
    ...
    'debug_tips'=>'Your JisuCMS has debug mode turned on, this mode of the site is at risk of attack and performance degradation. Please turn off the debug mode in time for the actual deployment of the site online!',
    'url_rewrite_tips'=>'Enable URL pseudo-static, more friendly to search engines and users and better security',
    'plugin_disable'=>'All plugins have been disabled, Please modify the jisucms/config/config.inc.php file plugin_disable=>0',
