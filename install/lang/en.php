 ...
 * Author: Xwordsman
 * Date: 2026-4-23
 * Description: JisuCMS Installation Language Pack
 */
return array(
    'installation_wizard'=>'JisuCMS installation wizard',
    'license_title'=>'License Agreement',
    'license_content' => 'Thank you for choosing JisuCMS. JisuCMS has the characteristics of safety, efficiency, stability, fast speed and super load, especially in the case of large data volume, its excellence is even more outstanding.
<br><br>
JisuCMS can load the templates on the mobile end and PC separately, and the URL remains unchanged. It has a very convenient plug-in and template development mechanism.
<br><br>
JisuCMS has only 20 tables and runs very fast. It processes a single request in 0.01 seconds. The separation of front and rear code and support of user-defined model content is a very good cornerstone of secondary development.
<br><br>
...
<br><br>
JisuCMS is development based on XiunoPHP open source framework, released under the MIT agreement, and you can freely modify and derive versions for commercial use without worrying about any legal risks (the original copyright information should be retained after modification).
<br><br>
The JisuCMS main program is free of charge and does not provide any form of free service. The user shall not apply the system to any form of illegal use, and all legal risks arising therefrom shall be borne by the user, which has nothing to do with the website and the developer. Once you download, install and use JisuCMS, you acknowledge that you have read, understood and agreed to be bound by this clause and comply with all relevant laws and regulations. If you do not agree to such terms, please do not use this program.
<br><br>
Warning: According to Chinese laws, do not disseminate relevant resources in any form (including but not limited to resource data files, seed files, online disk files, FTP files, etc.) without obtaining the authorization of relevant resources (including but not limited to films, animations, books, music, etc.).',
    ...
    'installed_tips' => 'You have been installed, and if you need to re install, please delete the jisucms/config/config.inc.php!',
