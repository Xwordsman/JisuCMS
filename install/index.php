...
//加载版本信息
require APP_PATH.'config/version.inc.php';
//框架名
...
if($do == 'lang') {
    ...
    $cfg = array(
        ...
        'copyright' => '底部版权信息',
        'seo_title' => '极速CMS',
        'seo_keywords' => '极速CMS,高性能CMS,内容管理系统',
        'seo_description' => '极速CMS - 高性能PHP内容管理系统',
        ...
        'admin_layout'=>0,  //后台布局（0=左侧菜单，1=顶部和左侧菜单）
        'auto_pic'=>1,  //自动缩略图
    ...
    // 清空缓存
    $runtime = ROOT_PATH.'/runtime/cache/';
