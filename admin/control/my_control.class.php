...
//        }
    ...
    private function get_used() {
        $arr = array(
            array('name'=>lang('setting'), 'url'=>'index.php?setting-index', 'icon'=>'fa fa-cog'),
            ...
            array('name'=>lang('theme_manage'), 'url'=>'index.php?theme-index', 'icon'=>'fa fa-paint-brush'),
            array('name'=>lang('plugin_manage'), 'url'=>'index.php?plugin-index', 'icon'=>'fa fa-plug'),
        );
